    ...
    <section className="py-16 md:py-24 lg:py-32">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
        ...
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-stretch">
          ...
          <Card className="group relative overflow-hidden p-8 hover:shadow-2xl transition-all duration-500 border-0 bg-gradient-to-br from-blue-dark/20 to-blue-darker/10 backdrop-blur-sm">
            {/* Background Glow Effect */}
            <div className="absolute inset-0 bg-gradient-to-br from-blue-primary/5 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
            ...
            <div className="relative z-10 h-full flex flex-col">
              ...
              <div className="inline-flex items-center gap-2 mb-6">
                ...
                <span className="text-xs font-medium tracking-wider uppercase" style={{ color: 'var(--blue-primary)' }}>
                  Live Project
                </span>
              </div>
          ...
          <Card className="group relative overflow-hidden p-8 hover:shadow-2xl transition-all duration-500 border-0 bg-gradient-to-br from-blue-dark/15 to-blue-darker/5 backdrop-blur-sm">
            {/* Background Glow Effect */}
            <div className="absolute inset-0 bg-gradient-to-br from-blue-accent/5 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
